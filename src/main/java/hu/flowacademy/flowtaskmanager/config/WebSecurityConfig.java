...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter implements ResourceServerConfigurer {
    ...
    public void configure(final HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                ...
                .antMatchers("/api/tasks/create").hasAnyAuthority(User.Role.MENTOR.name())
                .antMatchers("/api/tasks/**").hasAnyAuthority(User.Role.MENTOR.name())
                .antMatchers("/api/users", "/api/users/**").hasAnyAuthority(User.Role.MENTOR.name()) //, User.Role.STUDENT.name()
